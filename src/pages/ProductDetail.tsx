...
import { ArrowLeft, Minus, Plus, ShoppingCart, Share2, Heart, Star, ChevronLeft, ChevronRight, Camera, X, Send, MessageSquare } from 'lucide-react';
...
export const ProductDetail = () => {
  ...
  const handleReviewPhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const uploadPromises = Array.from(files).slice(0, 5 - reviewPhotos.length).map(async (file) => {
