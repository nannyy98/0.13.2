    ...
    >
      ...
      <div className="relative aspect-[4/5] bg-surface-100 dark:bg-surface-800 overflow-hidden">
        ...
        <button
          ...
          className="absolute top-2 right-2 w-10 h-10 rounded-full bg-white/85 backdrop-blur-sm flex items-center justify-center shadow-sm transition-all duration-150 hover:scale-110 active:scale-90"
        >
          <Heart
